...
/* Ce composant est le bouton "J'aime ce tweet" inclus dans ListTweet. Il comporte deux parties.
  Partie 1 : concernant les données de l'utilisateur qui clique sur le bouton. Elle met à jour la donnée "likedList" dans la partie userList de firebase.
            "likedList" contient les identifiants de tous les tweets likés par l'utilisateur.
