...
export default function FollowThisUser(){
    ...
    //console.log(`userList dans FollowThisUser : `, userList);
    ...
    const getUserlist = await fetch(
      ...
      console.log(" 3 --- La userList ; les données recueillies TRANSFORMÉES dans l'élément FollowThisUser : ", donneesTransformees);
...
console.log(` 4 ---- Le userConnectedData. Les informations stockées dans Realtime Database concernant l'utilisateur connecté en ce moment  : `, userConnectedData);
                return userConnectedData.followList
        };
