      ...
      {user ? (
        <>
          {preventLikedList.includes(tweet.id) ? (
            ...
            <img onClick={likeThisTweet} className="grey_like" src="../../../public/icone/empty_red.png" />
          )}
        </>
      ) : (
        <Link to="/connexion"><img className="grey_like" src="../../../public/icone/empty_red.png" /></Link>
      )}
    </>
  );
}
