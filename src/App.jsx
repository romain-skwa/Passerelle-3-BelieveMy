...
const router = createBrowserRouter([// va nous retourner un routeur
  {
    path: "/",
    errorElement: <Error />,// En cas d'erreur, cette page est affichée
    children: [// La propriété children est un tableau qui rassemble toutes nos adresses
      {
...
export default function App() {// on va utiliser le routeur retourné ici
